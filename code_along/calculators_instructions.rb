## Steps to completing coding group projects ##

# Some Brainstorming Questions:
#   1. What do you want your program to do?
#   2. What would would it look like to use?

# Add comments to your file to pseudocode your ideas once everyone is on the
# same page. Make sure to share the love. Everyone should be contributing
