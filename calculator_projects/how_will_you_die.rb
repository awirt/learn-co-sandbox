...
puts "1 to 10, 1 being not at all to 10 being yes all the time.".colorize(:light_cyan)
sleep (1.5) 
puts "remember has to be between 1 and 10!".upcase.red
...
puts "Third question: How much do you like your mom's cooking? (1 hate it!, 10 LOVE IT!)".colorize(:light_magenta)
question_3 = gets.strip.to_i
question_3 = death(question_3).to_i
total += question_3
#honorable

puts "Fourth question: how often do you look at memes? (1 not at all- never, 10 all the time).".green
question_4 = gets.strip.to_i
question_4= death(question_4).to_i
total += question_4
#phone on face 

puts "Fifth question: how often do you bathe?".cyan
...
scores.each do |bob|
  ...
  puts stories[highest_score_index]